...
const Steps = () => {
  return (
    ...
    className='flex flex-col items-center justify-center m-32'>
      <h1 className='text-black-700 inline-flex text-3xl sm:text-0xl font-bold text-center gap-2 bg-white px-28 py-4 rounded-full border hover:scale-105 border-neutral-500 transition-all duration-700'>How AI Generation Works</h1>
      <p className='text-lg text-gray-600 mb-8'>Transform Texts Into Stuning Images</p>
